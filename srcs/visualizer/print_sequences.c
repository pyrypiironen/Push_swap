...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/09/17 16:23:16 by ppiirone          #+#    #+#             */
/*   Updated: 2022/09/17 16:23:18 by ppiirone         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

# include "../../includes/push_swap.h"

void	print_sequence(t_data *d, t_stack **a, t_stack **b)
{
	while (1)
	{
		if ((*a) != NULL && d->segments == 31)
			print_sequence_32(d, a);
		else if ((*a) != NULL && d->segments == 15)
			print_sequence_16(d, a);
		else if ((*a) != NULL)
			print_sequence_3(d, a);
		else
			ft_printf("%35s", "");
		if ((*b) != NULL && d->segments == 31)
			print_sequence_32(d, b);
		else if ((*b) != NULL && d->segments == 15)
			print_sequence_16(d, b);
		else if ((*b) != NULL)
			print_sequence_3(d, b);
		ft_printf("\n");
		if ((*a) == NULL && (*b) == NULL)
			break ;
	}
...
void	print_sequence_3(t_data *d, t_stack **x)
{
	if ((*x)->segment == 0)
		ft_printf("{green}%30d     ", (*x)->sequence);
	else if ((*x)->segment == 1)
